...
const fvid = {
	 ...
	 { remoteJid: "6283199507332-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6283199407332-1616169743@g.us",
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "628319507332-1613049930@g.us",
      "fromMe": false,
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Tegal Botz Whatsapp_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
if(isButton == 'igm'){
reply('http://instagram.com/anak_meme_ges')
}
if(isButton == 'ytm'){
...
stamtus =`❏ 「 \`\`\`MENU MAKER\`\`\` 」
────────────────────
_contoh: ${prefix}tahta TegalBotz_
────────────────────
◈ ${prefix}nulis 「 text 」
◈ ${prefix}tahta 「 text 」
...
//LUPA
       case 'maker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Tegal Botz Whatsapp`)
					teksnya = args.join(" ")
					sticWait(from)
...
case 'nsloli':
           ...
           await alpha.sendMessage(from, cecan, image, { quoted:mek,caption:'Nih Ngab Ceweknya Lu🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break
...
ini_list.push({
"displayName": `Developer Tegal Botz Whatsapp`,
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Tegal Botz Whatsapp`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Tegal Botz Whatsapp`,
...
break
            ...
            break
				case 'attp':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp Tegal Botz Whatsapp`)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Tegal Botz Whatsapp`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Tegal Botz Whatsapp`, MessageType.extendedText,{
 quoted: {
key: {
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283199507332@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
...
alpha.sendMessage(from, `Tegal Botz Whatsapp`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
 ...
 quoted: {
  ...
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `${NamaOwner}`,
    orderTitle: `Tegal Botz Whatsapp`, // 
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_©Tegal Botz Whatsapp_*',
    buttons: punten,
    headerType: 1
}
